...
public class ItemListFragment extends Fragment {
    ...
    private void createData(int tab) {
        ...
        if(tab==0){
            Actor actor = new Actor("Thanh Hang",R.drawable.thanhhang);
            actorList.add(actor);
            actor = new Actor("Ngo Thanh Van",R.drawable.ntv);
            actorList.add(actor);
            actor = new Actor("My Tam",R.drawable.mytam1);
            actorList.add(actor);
        }else{
            Actor actor = new Actor("CR7",R.drawable.cr7);
            actorList.add(actor);
        }
